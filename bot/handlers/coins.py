...
async def inline_share_referral(inline_query: InlineQuery, db: Database):
    ...
    share_message = (
        ...
        f"🧠 Har xil qiziqarli vazifalar bajarasiz\n"
        f"💰 <b>KiberCoin</b> ishlab topasiz\n"
        f"🚀 Do'stlaringizni taklif qilib coin yutib oling\n"
        f"🏆 Hozir kiberxavfsizlik viktorinasi bo'lyapdi.\n"
        f"Ishtirok etish uchun ro‘yxatdan o‘ting.\n\n"
